...
RSpec.describe TranzitoUtils::TimeParser do
  let(:subject) { TranzitoUtils::TimeParser }
  let(:default_time_zone) { TranzitoUtils::DEFAULT[:time_zone] }
  ...
  describe "timezone_parser" do
    ...
    context "LA" do
      ...
      it "returns correct timezone" do
        ...
        expect(subject.parse_timezone(timezone_str).utc_offset).to eq default_time_zone.utc_offset
      end
    end
    ...
    context "Chicago" do
      ...
      it "returns correct timezone" do
        expect(subject.parse_timezone(timezone_str)).to eq target_timezone
        expect(subject.parse_timezone(timezone_str).utc_offset).to eq default_time_zone.utc_offset + 2.hours
      end
    end
    ...
    context "America/New York" do
      ...
      it "returns correctly" do
        expect(subject.parse_timezone("")).to eq default_time_zone
